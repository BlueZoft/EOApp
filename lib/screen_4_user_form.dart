...
class CustomerForm extends StatefulWidget {
  ...
  const CustomerForm({required this.askLoan, Key? key}) : super(key: key);
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: TextFormField(
                  ...
                  validator: (value) {
                    RegExp regExp = RegExp(r'^([0-9]{9}[xXvV]|[0-9]{12})$');
                    if (value!.isEmpty) {
                      return 'මෙම තොරතුරු අවශ්‍යයි';
                  ...
                  onSaved: (value) => _nic = value.toString()),
            ),
            Padding(
            ...
            Padding(
              ...
              child: TextFormField(
                  ...
                  onSaved: (value) => _telephone = value.toString()),
            ),
            Padding(
              padding: const EdgeInsets.fromLTRB(10, 0, 10, 0),
              child: TextFormField(
                ...
                child: TextFormField(
                    ...
                    validator: (value) {
                      String p = "[a-zA-Z0-9\+\.\_\%\-]{1,256}" +
                          ...
                          ")+";
                      RegExp mailreg = new RegExp(p);
                      if (value!.isNotEmpty && !mailreg.hasMatch(value)) {
            ...
            Padding(
              ...
              child: TextFormField(
                  ...
                  onSaved: (value) => _inquiry = value.toString()),
            ),
            Row(
              children: [
                SizedBox(
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  if (_sex.isNotEmpty &&_branch.isNotEmpty && formKey.currentState!.validate()) {
